...
const SEO: React.FC<SEOProps> = ({
  ...
  const seoContent = {
    de: {
      ...
      defaultDescription: 'HOT Pflegedienst - Professionelle häusliche Intensivpflege in Berlin. Beatmungspflege, Tracheostoma-Versorgung und umfassende medizinische Betreuung. 24/7 für Sie da.',
  ...
  return (
    <Helmet>
      ...
      {/* Brand-specific SEO */}
      <meta name="brand" content="HOT Pflegedienst" />
      <meta name="organization" content="HOT Pflegedienst GmbH" />
      <meta name="geo.region" content="DE-BE" />
      <meta name="geo.placename" content="Berlin" />
      <meta name="ICBM" content="52.5488, 13.3809" />
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Brand",
          "name": "HOT Pflegedienst",
          "alternateName": ["HOT Pflegedienst GmbH", "HOT Intensivpflege"],
          "url": "https://www.hotpflegedienst.de/",
          "logo": "https://www.hotpflegedienst.de/hotLOGO.jpg",
          "description": pageDescription,
          "sameAs": ["https://www.hotpflegedienst.de/"]
        })}
      </script>
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          "@type": "WebSite",
          "name": "HOT Pflegedienst",
          "alternateName": "HOT Pflegedienst GmbH",
          "url": "https://www.hotpflegedienst.de/",
          "potentialAction": {
            "@type": "SearchAction",
            "target": {
              "@type": "EntryPoint",
              "urlTemplate": "https://www.hotpflegedienst.de/"
            },
